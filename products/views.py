...
class ProductListCreateView(UserQuerySetMixin, StaffEditorPermissionMixin, generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        if content is None:
            ...
            serializer.save(user=self.request.user, content='more big house')
